        ...
        <Link href={href}>
          <a className={classes.link}>
            <div className={classes.header}>
              ...
              >
                <img
                  src="https://static.iqoption.com/v5/static/images/mask.7fbee3fac85c8080dbf5c8a53fd69318.png"
                  className={classes.headerRound}
                />
              </div>
              <div className={classes.headerBTN}>
                <div
                  className={classes.headerBTNIcon}
              ...
              <Typography className={classes.value}>
                ...
                <span
                  className={`${classes.valueChange} ${
                    isPositive
                      ? classes.valueChangePositive
                      : classes.valueChangeNegative
                  }`}
                >
                  &nbsp;{isPositive ? '+' : ''}
                  {priceChange}% <span>YTD</span>
                </span>
              </Typography>
